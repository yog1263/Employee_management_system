            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="edit.php" method="POST">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                     <input class="input--style-1" type="text" name="firstName" value="<?php echo $firstname;?>" autocomplete="off" >
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" name="lastName" value="<?php echo $lastname;?>" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="email"  name="email" value="<?php echo $email;?>" autocomplete="off">
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="tel" id="phone" name="contact" placeholder="Contact Number" pattern="[7-9]{1}[0-9]{9}" value="<?php echo $contact;?>" required autocomplete="off">
                        </div>
                        <!--<div class="input-group">
                        ...
                        <!--<div class="input-group">
                         ...
                         <div class="input-group">
                            <input class="input--style-1" type="text"  name="address" value="<?php echo $address;?>" autocomplete="off">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" name="dept" value="<?php echo $dept;?>" autocomplete="off">
                        </div>
