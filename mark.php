...
if(isset($_POST['update']))
{
 ...
 $result = mysqli_query($conn, "UPDATE project SET subdate = '$subdate',status = 'Submitted' WHERE eid=$eid and pid = $pid");
...
<?php
  $id = (isset($_GET['id']) ? $_GET['id'] : '');
  $pid = (isset($_GET['pid']) ? $_GET['pid'] : '');
  $sql = "SELECT pname,duedate FROM project WHERE eid='$id' AND pid='$pid'";
  ...
  $sql = "SELECT firstName,lastName FROM employee WHERE id='$id'";
  $result1 = mysqli_query($conn, $sql);
  if($result1){
  while($res = mysqli_fetch_assoc($result1)){
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="mark.php" method="POST">
                        ...
                        <div class="input-group">
                          <p>Project Name</p>
                            <input class="input--style-1" type="text"  name="pname" value="<?php echo $p_name;?>" readonly>
                        </div>
                       
                        
                        <div class="input-group">
                          <p>Employee Name</p>
                            <input class="input--style-1" type="text" name="firstName" value="<?php echo $first_Name;?> <?php echo $last_Name;?>" readonly>
                        </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                  <p>Due Date</p>
                                     <input class="input--style-1" type="text" name="duedate" value="<?php echo $due_date;?>" readonly>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                  <p>Submission Date</p>
                                    <input class="input--style-1" type="date"  name="subdate">
                                </div>
                            </div>
                        </div>
